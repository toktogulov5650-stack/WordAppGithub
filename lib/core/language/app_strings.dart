...
class AppStrings {
  ...
  String get russian => isRu ? 'Русский' : 'Русский';
  ...
  String get categoriesLoadFailed => isRu
      ? 'Не удалось загрузить категории'
      : 'Категорияларды жүктөө мүмкүн болгон жок';
  String get noCategories => isRu
      ? 'Категории пока не добавлены'
      : 'Категориялар азырынча кошула элек';
  ...
  String get flashcardLoading =>
      isRu ? 'Карточка загружается...' : 'Карта жүктөлүп жатат...';
  String get noFlashcards => isRu ? 'Пока нет карточек' : 'Азырынча карта жок';
  String get flashcardLoadFailed => isRu
      ? 'Не удалось загрузить карточку'
      : 'Картаны жүктөө мүмкүн болгон жок';
  String get nextFlashcard => isRu ? 'Следующая карточка' : 'Кийинки карта';
  String get english => isRu ? 'Английский' : 'Англис тили';
  String get currentLanguageName => isRu ? 'Русский' : 'Кыргыз тили';
  String get explanations => isRu ? 'Объяснения' : 'Түшүндүрмөлөр';
  String get words => isRu ? 'Слова' : 'Сөздөр';
  String get wordsLoading =>
  ...
  String get explanationLoadFailed => isRu
      ? 'Не удалось загрузить объяснение'
      : 'Түшүндүрмөнү жүктөө мүмкүн болгон жок';
  ...
  String get testPreparing =>
      isRu ? 'Тест готовится...' : 'Тест даярдалып жатат...';
  String get testStartFailed =>
      isRu ? 'Не удалось начать тест' : 'Тестти баштоо мүмкүн болгон жок';
  String questionNumber(int number) =>
      isRu ? 'Вопрос $number' : 'Суроо $number';
  ...
  String get resultLoadFailed => isRu
      ? 'Не удалось загрузить результат'
      : 'Жыйынтыкты жүктөө мүмкүн болгон жок';
  ...
  String get noUnknownWords =>
      isRu ? 'Неизвестных слов нет' : 'Белгисиз сөз жок';
  String get profile => isRu ? 'Профиль' : 'Жеке кабинет';
  String get profileSubtitle =>
      isRu ? 'Аккаунт и текущая сессия' : 'Аккаунтуңуз жана учурдагы сессия';
  String get profileLoading =>
      isRu ? 'Профиль загружается...' : 'Профиль жүктөлүп жатат...';
  String get profileLoadFailed => isRu
      ? 'Не удалось загрузить профиль'
      : 'Профилди жүктөө мүмкүн болгон жок';
  ...
  String get basicDescription => isRu
      ? 'Базовые слова для повседневной практики.'
      : 'Күнүмдүк керектүү негизги сөздөр.';
  String get travelDescription => isRu
      ? 'Слова, которые часто нужны в путешествии.'
      : 'Саякатта көп колдонулуучу сөздөр.';
  String get foodDescription => isRu
      ? 'Слова о еде и повседневных продуктах.'
      : 'Тамак-аш жана күнүмдүк азык сөздөрү.';
  String get verbsDescription => isRu
      ? 'Подборка часто используемых глаголов.'
      : 'Көп колдонулган этиштер жыйнагы.';
  String get fallbackDescription1 =>
      isRu ? 'Слова для легкого повторения.' : 'Жеңил кайталоо үчүн сөздөр.';
  String get fallbackDescription2 => isRu
      ? 'Удобный набор для запоминания.'
      : 'Эсте сактоого ыңгайлуу топтом.';
  String get fallbackDescription3 =>
      isRu ? 'Слова для следующего шага.' : 'Кийинки кадамга ылайык сөздөр.';
  String get verbsExplanation => isRu
      ? 'Посмотрите глаголы с примерами.'
      : 'Этиштерди мисалдары менен караңыз.';
  String get travelExplanation => isRu
      ? 'Набор слов для путешествий.'
      : 'Саякатка керектүү сөздөр топтому.';
  String get foodExplanation =>
      isRu ? 'Слова, связанные с едой.' : 'Тамак-ашка байланышкан сөздөр.';
  String get basicExplanation => isRu
      ? 'Быстро повторите базовые слова.'
      : 'Негизги сөздөрдү тез кайталаңыз.';
  String get explanationFallback1 =>
      isRu ? 'Важные слова по теме.' : 'Тема боюнча маанилүү сөздөр.';
  String get explanationFallback2 => isRu
      ? 'Слова для повседневного использования.'
      : 'Күнүмдүк колдонулган сөздөр.';
